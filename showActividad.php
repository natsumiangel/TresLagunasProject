...
$row = mysql_fetch_array(mysql_query("SELECT * FROM `actividades` WHERE `idActividad` = ".$idActividad.""));
...
<p><a id="Titulos2"><? echo("$".$row["tarifa"]."");?></a>(MXN) Por Persona,  <a id="Titulos2"><? echo("".$row["maxPersonas"]."");?></a> Personas (Capacidad Máxima). </p> 
</body>
</html>
